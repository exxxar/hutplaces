        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <select id="team" class="form-control" v-model="team">
                    ...
                    <option>JYP Jyvaskyla</option>
                    <option>ERC Ingolstadt</option>
                    <option>HC Sparta Praha</option>
                    <option>HC Vitkovice Steel</option>
                    <option>HC Vita Hasten</option>
                    <option>HC Dynamo Pardubice</option>
                    <option>Bridgeport Sound Tigers</option>
                    <option>Banska Bystrica</option>
                    <option>Kolner Haie</option>
                    <option>Adler Mannheim</option>
                    <option>Lehigh Valley Phantoms</option>
                    <option>Laval Rockets</option>
                    <option>Augsburger Panther</option>
                    <option>Milwaukee Admirals</option>
                    <option>Utica Comets</option>
                    <option>Stockton Heat</option>
                    <option>Storhamar Hamar</option>
                    <option>Syracuse Crunch</option>
                    <option>Hartford Wolf Pack</option>
                    <option>Hartford Whalers</option>
                    <option>Cleveland Monsters</option>
                    <option>Wilkes-Barre/Scranton Penguins</option>
                    <option>Hershey Bears</option>
                    <option>Charlotte Checkers</option>
                    <option>Belleville Senators</option>
                    <option>Binghamton Devils</option>
                    <option>HC Fribourg-Gotteron</option>
                    <option>Brynas IF</option>
                    <option>Skelleftea AIK</option>
                    <option>Vaxjo Lakers</option>
                    <option>HC Davos</option>
                    <option>HC Ambri-Piotta</option>
                    <option>Thomas Sabo Ice Tigers</option>
                    <option>Medicine Hat Tigers</option>
                    <option>Medvescak Zagreb</option>
                    <option>HC VERVA Litvinov</option>
                    <option>HC Energie Karlovy Vary</option>
                    <option>Pirati Chomutov</option>
                    <option>HC Lausanne</option>
                    <option>Grizzly Adams Wolfsburg</option>
                    <option>Rapperswil-Jona Lakers</option>
                    <option>San Jose Barracuda</option>
                    <option>Fort Wayne Komets</option>
                    <option>Springfield Thunderbirds</option>
                    <option>Malmo Redhawks</option>
                    <option>Almtuna IS</option>
                    <option>Newfoundland Growlers</option>
                    <option>HV71</option>
                    <option>Sodertalje SK</option>
                    <option>Helsingin IFK</option>
                    <option>Dusseldorfer EG</option>
                    <option>Lulea Hockey</option>
                    <option>Fischtown Pinguins</option>
                    <option>Graz 99ers</option>
                    <option>Norway</option>
                    <option>Norfolk Admirals</option>
                    <option>Iserlohn Roosters</option>
                    <option>SaiPa Lappeenranta</option>
                    <option>Mountfield HK</option>
                    <option>HC Olomouc</option>
                    <option>HC Ocelari Trinec</option>
                    <option>Tri-City Americans</option>
                    <option>Rogle BK</option>
                    <option>Vienna Capitals</option>
                    <option>Orebro Hockey</option>
                    <option>Straubing Tigers</option>
                    <option>EC VSV</option>
                    <option>Schwenninger Wild Wings</option>
                    <option>BK Mlada Boleslav</option>
                    <option>Krefeld Pinguine</option>
                    <option>Portland Pirates </option>
                    <option>Portland Winter Hawks</option>
                    <option>Halifax Mooseheads</option>
                    <option>Oulun Karpat</option>
                    <option>KooKoo Kouvala</option>
                    <option>Kootenay Ice</option>
                    <option>Leksands IF</option>
                    <option>Rauman Lukko</option>
                    <option>HPK Hameenlinna</option>
                    <option>Hamilton Bulldogs</option>
                    <option>PSG Zlin</option>
                    <option>Karlskrona HK</option>
                    <option>Mora IK</option>
                    <option>Black Wings Linz</option>
                    <option>Atlanta Gladiators</option>
                    <option>Tampereen Tappara</option>
                    <option>IK Pantern</option>
                    <option>Toledo Walleye</option>
                    <option>Sudbury Wolves</option>
                    <option>HCB Sudtirol Alperia</option>
                    <option>Great Britain</option>
                    <option>Greenville Swamp Rabbits</option>
                    <option>Tampereen Ilves</option>
                    <option>Wheeling Nailers</option>
                    <option>Dornbirner EC</option>
                    <option>Idaho Steelheads</option>
                    <option>Mikkelin Jukurit</option>
                    <option>KalPa Kuopio</option>
                    <option>Kalamazoo Wings</option>
                    <option>Farjestad BK</option>
                    <option>Kansas City Mavericks</option>
                    <option>Sault Ste. Marie Greyhounds</option>
                    <option>Mississauga Steelheads</option>
                    <option>Missouri Mavericks</option>
                    <option>Cincinnati Cyclones</option>
                    <option>SAPA Fehervar AV 19</option>
                    <option>Brandon Wheat Kings</option>
                    <option>Brampton Beast</option>
                    <option>EC KAC</option>
                    <option>Orlando Solar Bears</option>
                    <option>Allen Americans</option>
                    <option>Adirondack Thunder</option>
                    <option>Reading Royals</option>
                    <option>Rapid City Rush</option>
                    <option>Maine Mariners</option>
                    <option>Timra IK</option>
                    <option>Vaasan Sport</option>
                    <option>Moose Jaw Warriors</option>
                    <option>Kelowna Rockets</option>
                    <option>HC TWK Innsbruck</option>
                    <option>MODO Hockey</option>
                    <option>Pelicans Lahti</option>
                    <option>South Carolina Stingrays</option>
                    <option>Worcester Railers</option>
                    <option>AIK</option>
                    <option>Indy Fuel</option>
                    <option>Wichita Thunder</option>
                    <option>Porin Assat</option>
                    <option>Orli Znojmo</option>
                    <option>Owen Sound Attack</option>
                    <option>Kitchener Rangers</option>
                    <option>Regina Pats</option>
                    <option>IF Bjorkloven</option>
                    <option>Kingston Frontenacs</option>
                    <option>Acadie-Bathurst Titan</option>
                    <option>Vasterviks IK</option>
                    <option>Utah Grizzlies</option>
                    <option>Tulsa Oilers</option>
                    <option>IK Oskarshamn</option>
                    <option>Jacksonville IceMen</option>
                    <option>Spokane Chiefs</option>
                    <option>Victoriaville Tigres</option>
                    <option>Victoria Royals</option>
                    <option>Saginaw Spirit</option>
                    <option>Guelph Storm</option>
                    <option>London Knights</option>
                    <option>Drummondville Voltigeurs</option>
                    <option>Tingsryds AIF</option>
                    <option>GKS Tychy</option>
                    <option>Sherbrooke Phoenix</option>
                    <option>Peterborough Petes</option>
                    <option>Swift Current Broncos</option>
                    <option>North Bay Battalion</option>
                    <option>Rimouski Oceanic</option>
                    <option>Quebec Remparts</option>
                    <option>Prince Albert Raiders</option>
                    <option>Gatineau Olympiques</option>
                    <option>Blainville-Boisbriand Armada</option>
                    <option>Windsor Spitfires</option>
                    <option>BIK Karlskoga</option>
                    <option>Neman Grodno</option>
                    <option>Everett Silvertips</option>
                    <option>Baie-Comeau Drakkar</option>
                    <option>Charlottetown Islanders</option>
                    <option>Kamloops Blazers</option>
                    <option>Seattle Thunderbirds</option>
                    <option>Red Deer Rebels</option>
                    <option>Niagara IceDogs</option>
                    <option>Flint Firebirds</option>
                    <option>St. Johns Ice Caps</option>
                    <option>Saint John Sea Dogs</option>
                    <option>Val-D'Or Foreurs</option>
                    <option>Valerenga Ishockey</option>
                    <option>Oshawa Generals</option>
                    <option>Lethbridge Hurricanes</option>
                    <option>Aalborg Pirates</option>
                    <option>Cape Breton Screaming Eagles</option>
                    <option>Saskatoon Blades</option>
                    <option>Moncton Wildcats</option>
                    <option>Prince George Cougars</option>
                    <option>Erie Otters</option>
                    <option>Chicoutimi Sagueneens</option>
                    <option>Rouyn-Noranda Huskies</option>
                    <option>Shawinigan Cataractes</option>
                    <option>Minnesota North Stars</option>
                    <option>Quebec Nordiques</option>
                    ...
                    <option>USA</option>
                    <option>Atlantic All-Stars</option>
                    <option>Pacific All-Stars</option>
                    <option>Binghamton Senators</option>
                    <option>Springfield Falcons</option>
                    <option>Latvia</option>
                    <option>Lake Erie Monsters </option>
...
<script>
    export default {
        ...
        methods: {
            ...
            getCard(id) {
                this.$loading(true)
                this.request = `https://hutdb.net/ajax/id.php?size=0&id=${id}`;
                axios.post('search', {url: this.request})
                    .then(res => {
                        console.log(res);

                        this.cardExample = JSON.parse(JSON.stringify(res.data.value).replace(/\/assets/gi, 'https://hutdb.net/assets'));
                        this.$loading(false)
                        this.show("card")
