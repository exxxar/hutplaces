...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    loadCurrentUser: function loadCurrentUser(newValue, oldValue) {
      this.user = newValue;
  ...
  methods: {
    ...
    save: function save() {
      ...
      axios.post('/auction/update', formData).then(function (response) {
        _this2.message(_this2.$lang.game.success_1);

        _this2.$store.dispatch("loadAuctions");
      })["catch"](function (error) {
                    ...
                    _c(
                      "router-link",
                      {
                        ...
                        attrs: {
                          ...
                          to: {
                            name: "PlayerInfo",
                            params: { userId: _vm.auc.buyer_id == null }
                          }
                        }
                      },
                      [
                        _c("img", {
                          attrs: {
                            src: _vm.prepareAvatar(_vm.auc.buyer.avatar),
                            alt: ""
                          }
                        })
                      ]
                              ...
                              directives: [
                                {
                                  name: "lazy",
                                  rawName: "v-lazy",
                                  value: "/img/cards/" + _vm.auc.lot.card.image,
                                  expression:
                              ...
                              directives: [
                                {
                                  name: "lazy",
                                  rawName: "v-lazy",
                                  value: "/img/cards/" + _vm.auc.lot.item.image,
                                  expression:
                            ...
                            _vm.auc.buyer_id == null
                              ? _c(
                                  "div",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.cancelLot(_vm.auc.id)
                                      }
                                    }
                                  },
                                  [
                          ...
                          _c(
                            ...
                            [
                              _c("label", {
                                ...
                                attrs: { for: "active-type-" + _vm.auc.id },
                                domProps: {
                              ...
                              _c("toggle", {
                                attrs: {
                                  check: _vm.auc.active == 1 ? true : false,
                                ...
                                on: {
                                  change: [
                                    function($event) {
                                      ...
                                      _vm.selected_lifetime = $event.target
                                        .multiple
                                        ? $$selectedVal
                                        : $$selectedVal[0]
                                    },
