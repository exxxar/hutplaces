  ...
  data: function data() {
    return {
      games: [{
        ...
        lottery_count: 78,
        slides: [this.addSlide('img/nhl-banner.jpg'), this.addSlide('img/nhl-banner.jpg'), this.addSlide('img/nhl-banner.jpg'), this.addSlide('img/nhl-banner.jpg')]
      }, {
        route: 'nhl',
        logo: 'https://upload.wikimedia.org/wikipedia/en/thumb/e/ea/EA_Sports.svg/220px-EA_Sports.svg.png',
        url: 'http://www.easports.com/nhl',
        ...
        lottery_count: 78,
        slides: [this.addSlide(img), this.addSlide(img), this.addSlide(img), this.addSlide(img)]
      }]
    };
  }
});
