...
class CardsStorageHUTDBController extends Controller
{
    /**
    ...
    {
        $cardstorages = CardsStorageHUTDB::orderBy('id', 'DESC')->paginate(15);
    ...
    public function store(Request $request)
    {
        ...
        $cardstorage = CardsStorageHUTDB::create($input);
    ...
    {
        $cardstorage = CardsStorageHUTDB::find($id);
    ...
    public function add(Request $request)
    {
        ...
        $card = CardsStorageHUTDB::create($request->get("data")["card"]);
